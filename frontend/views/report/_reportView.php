...
<p style="text-indent: 2.5cm;">
    ด้วยโรงเรียนลิ้นฟ้าพิทยาคม  ได้ดำเนินการ<?=$document->do?> เพื่อใช้ในโครงการ <?=$document->plan?> กิจกรรม <?=$document->for?>  จาก <?=$document->supplier->name?> จำนวน <?=$description_count?> รายการ เป็นจำนวนเงิน <?=$formatter->asDecimal($total)?> บาท (<?= $bahttext ?>)  ตามใบเสร็จรับเงินเลขที่ <?=$document->invoice_id?> ลงวันที่ <?=$document->invoice_date?>
</p>
<p style="text-indent: 2.5cm;">
...
<table width="100%">
    <tr>
        ...
        <td style="line-height:25px">
            ใบเบิก เลขที่ จ.<?=$document->doc_id?> /<?=$document->year?><br>
